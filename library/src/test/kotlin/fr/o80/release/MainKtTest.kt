...
import fr.o80.release.Helpers.getFolder
...
internal class MainKtTest {
    ...
    fun goldenMasterTestV1() {
        val outputV1 = ChangelogGenerator(Helpers.configuration).generate(getFolder(".changes"), listOf("1"))
        assertEquals(expectedOutputV1, outputV1)
    }

    @Test
    fun goldenMasterTestV2() {
        val outputV2 = ChangelogGenerator(Helpers.configuration).generate(getFolder(".changes"), listOf("2"))
        assertEquals(expectedOutputV2, outputV2)
    }

    @Test
    fun goldenMasterTestAll() {
        val outputV1 = ChangelogGenerator(Helpers.configuration).generate(getFolder(".changes"), listOf("2", "1"))
